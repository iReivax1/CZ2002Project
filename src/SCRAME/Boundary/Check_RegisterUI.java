...
public class Check_RegisterUI {
	...
	public void setAcadHumanController(AcademicsController acadCtrl, HumanController humanCtrl) 
	{
	...
	public void registrationDisplay()
	{
		...
		while(true)
		{
			...
			if(humanCtrl.isStudentInList(this.matricNumber))
				break;
		...
		if(humanCtrl.isCourseRegistered(this.matricNumber, this.facultyName, this.courseCode))
		{
	...
	public void displayVacancy()
	{
		...
		//get course the student is registering for
		System.out.println("Input course to register for");
		this.courseCode = displayCourseList(true);
